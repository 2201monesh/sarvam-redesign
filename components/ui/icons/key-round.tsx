...
const KEY_VARIANTS: Variants = {
  normal: { rotate: 0 },
  animate: { rotate: [0, -15, 12, -6, 0], transition: { duration: 0.6, ease: "easeInOut" } },
};
    ...
    return (
      <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        <svg fill="none" height={size} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width={size}>
          <motion.g animate={controls} style={{ transformOrigin: "12px 12px" }} variants={KEY_VARIANTS}>
            ...
            <circle cx="16.5" cy="7.5" fill="currentColor" r=".5" stroke="none" />
          </motion.g>
        </svg>
      </div>
    );
